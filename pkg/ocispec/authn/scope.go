...
// DefaultRegistryCatalogScope is the scope for registry catalog access.
const DefaultRegistryCatalogScope = "registry:catalog:*"

// RepositoryScope returns a repository scope with given actions.
// Reference: https://docs.docker.com/registry/spec/auth/scope/
